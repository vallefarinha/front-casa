...
const Petra = () => {
  ...
  return (
    <div className=" mx-auto our-history-container">
      ...
      <div
        className="our-history-section bg-primaryColor bg-opacity-60 h-screen custom-height pt-2"
        id="Section2"
      >
        <div className="relative">
      ...
      >
        ...
        <div className="flex flex-wrap h-screen justify-around w-[80%] mx-auto py-2 items-center overflow-y-auto custom-height">
          <div className="lg:w-[45%] my-auto">
            ...
            <TitleHistory wordBlue={"La abertura de la"} wordPink={"Casa de los Pobres"} />  
            </div>
      ...
      >
        ...
        <div className="flex flex-wrap justify-around h-screen w-[80%] mx-auto">
          ...
          <div className="lg:w-[50%] my-auto">
            ...
            <TitleHistory wordBlue={"La fuerza de la "} wordPink={"virtud"} />
              </div>            
              <p className="text-LetterColor font-poppinsRegular text-xl md:text-lg  text-justify">
            ...
            />
              ...
              <p className="text-LetterColor font-poppinsRegular text-xl md:text-lg  text-justify">
              Por fortuna, sus numerosas cualidades le sirvieron para sobrellevar todos los contratiempos que surgieron. Era una mujer de recia personalidad, carácter equilibrado, y admirable capacidad para afrontar el día a día en medio del rigor, siempre con esperanza, alegría y sencillez, sabiéndose en manos de Dios. Las dificultades de distinto signo, calumnias y persecuciones incluidas, no hicieron más que acrecentar sus virtudes. Quienes la vituperaron no hallaron en ella más respuesta que la caridad y el perdón. De algún modo previno a sus hijas de lo que podía recaer sobre la comunidad. Así, un día, celebrando entrañablemente la festividad de la epifanía en la que cada una ofrecía al Niño lo que brotaba de su interior, la fundadora les advirtió:
              </p>
              <div className="flex w-full justify-center">
            <Quote
        ...
        <div className="flex flex-wrap h-screen justify-around w-[80%] mx-auto py-2 items-center overflow-y-auto custom-height">
          <div className="lg:w-[45%] my-auto">
            ...
            <TitleHistory wordBlue={"El triste"} wordPink={"adiós"} />  
              ...
              <p className="text-LetterColor font-poppinsRegular text-xl md:text-lg  text-justify">
              Al final de su generosa vida en pro de los necesitados, y después de haber fundado 10 casas, le sorprendió una grave enfermedad que le produjo gran sufrimiento, uniéndose a los muchos que ya había padecido. Entregó su alma a Dios en Barcelona, a los 60 años, el 16 de agosto de 1906. A fuerza de amar llegaba a la cima soñada de la que habló a sus religiosas:               </p>
              <div className="flex w-full justify-center">
            <Quote
      ...
      >
        ...
        <div className="flex flex-wrap justify-around h-screen w-[80%] mx-auto">
          ...
          <div className="lg:w-[50%] my-auto">
            ...
            <TitleHistory wordBlue={"La beatificación de la "} wordPink={"Madre Petra"} />
              </div>            
              <p className="text-LetterColor font-poppinsRegular text-xl md:text-lg  text-justify">
              Su devoción a san José, en cuyo honor había tomado su nombre, le ha conferido el título de apóstol josefino del siglo XIX. Dio a sus hijas como modelo para su santificación el de la Sagrada Familia. Aludiendo a Cristo, confesaba humildemente:</p>              
              <div className="flex w-full justify-center">
            <Quote
