      ...
      <div className=" bg-quarteryColor bg-opacity-60 py-4 lg:py-2 px-4 lg:px-7">
        ...
        <div className="border-dashed border-4 border-secondaryColor p-4 mx-auto rounded-lg">
          ...
          <h2 className="text-2xl md:text-4xl text-LetterColor font-poppinsExtraBold">
            ...
            <p className="text-LetterColor text-xl md:text-lg lg:text-xl text-justify">
            Se tomó la decisión de que las niñas de la Casa Hogar asistieran a clases en el colegio durante el día y regresaran por la noche para dormir. Sin embargo, esta situación fue de corta duración.
            </p>
            <p className="text-LetterColor text-xl md:text-lg lg:text-xl text-justify">
            El 19 de octubre de 1972, se decidió unificar las dos comunidades, cerrando la Casa de la Guía y trasladando a todas las niñas al Colegio Virgen Reina, lo que llevó al cierre definitivo de la Casa Hogar en 1972.            </p>
            <p className="text-LetterColor text-xl md:text-lg lg:text-xl text-justify">
            Una de las madres que vivió este momento recuerda con tristeza el día en que dejaron la Casa de la Guía. Arrodilladas junto al pozo que se encuentra en el prado, rezaron a San José y, con gran pesar, decidió arrojar una pequeña imagen del santo al fondo del pozo, pidiéndole que cuidara de la Casa donde habían sido tan felices con las niñas.            </p>
            <p className="text-LetterColor text-xl md:text-lg lg:text-xl text-justify">
            A partir de ese momento, la Casa de la Guía quedó al servicio de la comunidad del Colegio de Gijón. Durante mucho tiempo, se utilizó como parvulario del colegio y también para convivencias de los alumnos, así como colonias de verano para los niños de los hogares. Con el paso del tiempo, la casa se deterioró considerablemente al no estar habitada. A pesar de intentos de venta, no fue posible, incluso después de colocar letreros de venta.            </p>
            <p className="text-LetterColor text-xl md:text-lg lg:text-xl text-justify">
            Las experiencias de las niñas del Hogar de Madrid que venían a veranear inspiraron la idea de reavivar el futuro de esta casa, ya que su especial carácter no se entendía sin vida y sin niños. Cuando la vieja Casa Indiana se hundió, surgieron muchas voces que hablaban de reconstruirla, pensando en crear un hogar para niños necesitados, que fue el motivo principal por el que la Congregación la adquirió.            </p>
          </div>
        </div>
