  ...
  return (
    <div className="flex flex-col items-center w-[85%] mx-auto mt-6">
        ...
        <img src={heart} alt="heart"  className="w-[55px] h-[59px] absolute top-[40%] left-[10%] transform -translate-x-1/2 -translate-y-1/2 md:w-[108px] md:h-[100px] md:left-[111%] md:top-[42%]" />
          ...
          <BoxSelect amount="SEMESTRAL" customStyle={{width: '150px', height: '50px'}} textSize="lg" className="mb-4 md:mb-0" inputRef={inputRef} onClick={handleSelectClick} isSelected={selectedPeriodicity === "SEMESTRAL"}/>
          <BoxSelect amount="ANUAL" customStyle={{width: '150px', height: '50px'}} textSize="lg" className="mb-4 md:mb-0" inputRef={inputRef} onClick={handleSelectClick} isSelected={selectedPeriodicity === "ANUAL"}/>
