  ...
  return (
    <div>
       ...
       <li>Deducción del 80% para los primeros 250 euros donados.</li> 
        <li>A partir de ese importe, es decir para el importe donado por encima de los primeros 250 euros:</li>
            <ul>
...
Para  incluir el donativo en la Desgravación Fiscal (Declaración de la Renta)  es necesario que nos facilite la siguiente información: Nombre y  apellidos, dirección postal, DNI e email. Si tiene cualquier duda  estamos a su disposición en casadeacogidaguia@hotmail.es 
        </p>
